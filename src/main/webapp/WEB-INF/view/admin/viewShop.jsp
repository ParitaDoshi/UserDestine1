...
<%@taglib prefix="c" uri="http://java.sun.com/jstl/core_rt" %>
        ...
        <div class="content-wrapper">
          <div class="page-header">
            ...
            <nav aria-label="breadcrumb">
              <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="#">Manage Restaurant</a></li>
                <li class="breadcrumb-item active" aria-current="page">View Restaurant</li>
              </ol>
            </nav>
          </div>
          <div class="card">
                ...
                <div class="col-12">
                  <div class="table-responsive">
                    <table id="order-listing" class="table">
                      ...
                      <tbody>
                   <c:forEach items="${viewdata}" var="s" varStatus="j">
                        <tr>
                        	<td>${j.count}</td>
                        	<td>${s.firstname}</td>
                        	<td>${s.lastname}</td>
                        	<td>${s.loginfvo.username}</td>
                        	<td>${s.mobileno}</td>
                        	<td>${s.emailid}</td>
                        	<td>${s.address}</td>
                        	<td>${s.gender}</td>
                        	 <td>${s.loginfvo.password}</td>
                      		 <td>${s.categoryforeignkeyvo.category_name}</td>
                        	<td>${s.subcategoryfVO.subcategoryname}</td>
                        	<td>${s.cityfVO.cityname}</td>
                        	<td>${s.areafVO.areaname}</td>
                            <td>${s.ownerregistrationid}</td>
                             <td> <img src="${pageContext.request.contextPath}/document/${s.shopProfilePhotoName}" alt=""></td>
                            <td>${s.ownershopname}</td>
                            <td>${s.shopdescription}</td>
                           
                            <td>
                              <button class="btn btn-outline-primary" ><a href="editshoppage?ownerregistrationid=${s.ownerregistrationid}">Edit</a></button>
                               <button class="btn btn-outline-primary"><a href="deleteshopdata?ownerregistrationid=${s.ownerregistrationid}">Delete</a></button>
                            </td>
                        </tr>
  ...
  <script src="${pageContext.request.contextPath}/adminResources/js/data-table.js"></script>
