          ...
          <div class="row">
            <div class="col-lg-12">
             ...
             <%@taglib prefix="f" uri="http://www.springframework.org/tags/form"%>
                  <f:form class="cmxform" id="signupForm" method="get" action="addsubcategory" modelAttribute="x">
                    <fieldset>
                      ...
                      <div class="form-group">
                       ...
                       <div class="form-group">
                        <label for="SubCategory Name">SubCategory Name</label>
                         <f:input path="subcategoryname" class="form-control" required="required"></f:input>
                      </div>
                      
                      <div class="form-group">
                        <label for="SubCategory Description">SubCategory Description</label><br/>
                       <f:textarea path="subcategorydescription" rows="5" cols="30" class="form-control" required="required"></f:textarea>
                      </div>
