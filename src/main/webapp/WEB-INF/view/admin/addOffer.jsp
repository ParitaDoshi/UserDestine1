          ...
          <div class="row">
            <div class="col-lg-12">
              ...
              <%@taglib prefix="f" uri="http://www.springframework.org/tags/form"%>
                  <f:form class="cmxform" id="signupForm" method="get" action="addoffer" modelAttribute="x">
                    <fieldset>
                    
                     <div class="form-group">
                        <label for="Shop Name">Shop</label><br/>
                        <f:select path="registrationfVO.ownerregistrationid" class="form-control" required="required">
                        <c:forEach  items="${shopls}"  var="y">
								<option value="${y.ownerregistrationid}">${y.ownershopname}</option>
						</c:forEach>
                        </f:select>
                      </div> 
