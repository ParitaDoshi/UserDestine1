                      ...
                      <tbody>
                       <c:forEach items="${viewdata}" var="s" varStatus="j">
                        <tr>  
                            ...
                            <td>
                              <button class="btn btn-outline-primary" ><a href="editcategorypage?category_id=${s.category_id}">Edit</a></button>
                               <button class="btn btn-outline-primary"><a href="deletecategorydata?category_id=${s.category_id}">Delete</a></button>
                            </td>
