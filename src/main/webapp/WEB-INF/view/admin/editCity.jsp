        ...
        <div class="content-wrapper">
          ...
          <div class="row">
            ...
            <%@taglib prefix="f" uri="http://www.springframework.org/tags/form"%>
                  <f:form class="cmxform" id="signupForm" method="get" action="addcity" modelAttribute="x">
                    <fieldset>
                    
                    
                       <div class="form-group">
                        <label for="City Name">City Name</label>
                        <f:input path="cityname" class="form-control" required="required"></f:input>
                      </div>
                      
                      <div class="form-group">
                        <label for="City Description">City Description</label><br/>
                       <f:textarea path="citydescription" rows="5" cols="30" class="form-control" required="required"></f:textarea>
                      </div>
