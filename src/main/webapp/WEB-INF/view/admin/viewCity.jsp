                      ...
                      <tbody>
                       <c:forEach items="${viewdata}" var="s" varStatus="j">
                        <tr>
                            ...
                            <td>
                              <button class="btn btn-outline-primary" ><a href="editcitypage?cityid=${s.cityid}"">Edit</a></button>
                               <button class="btn btn-outline-primary"><a href="deletecitydata?cityid=${s.cityid}"">Delete</a></button>
                            </td>
                        </tr>
