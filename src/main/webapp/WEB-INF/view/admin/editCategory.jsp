          ...
          <div class="row">
            <div class="col-lg-12">
              ...
              <%@taglib prefix="f" uri="http://www.springframework.org/tags/form"%>
                  <f:form class="cmxform" id="signupForm" method="GET" action="addcategory" modelAttribute="x">
                    <fieldset>
                      <div class="form-group">
                        <label for="Category Name">Category Name</label>
                       <f:input path="category_name" class="form-control" required="required"></f:input>
                      </div>
                      <div class="form-group">
                        <label for="Category Description">Category Description</label><br/>
                       <f:textarea path="category_description" rows="5" cols="30" class="form-control" required="required"></f:textarea>
                      </div>
