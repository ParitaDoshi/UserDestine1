        ...
        <div class="content-wrapper">
          <div class="page-header">
            ...
            <nav aria-label="breadcrumb">
              <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="#">Manage Area</a></li>
                <li class="breadcrumb-item active" aria-current="page">View Area</li>
              </ol>
            </nav>
          </div>
          <div class="card">
                  ...
                  <div class="table-responsive">
                    <table id="order-listing" class="table">
                      ...
                      <tbody>
                        ...
                        <tr>
                            <td>${j.count}</td>
                            <td>${s.cityforeignkeyvo.cityname}</td>
                            <td>${s.areaname}</td>
                            <td>${s.areadescription}</td>
                           
                            <td>
                              <button class="btn btn-outline-primary" ><a href="editareapage?areaid=${s.areaid}"">Edit</a></button>
                               <button class="btn btn-outline-primary"><a href="deleteareadata?areaid=${s.areaid}"">Delete</a></button>
                            </td>
                        </tr>
