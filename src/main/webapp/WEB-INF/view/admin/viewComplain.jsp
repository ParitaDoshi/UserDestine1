                  ...
                  <div class="table-responsive">
                   ...
                   <c:forEach items="${viewdata}" var="s" varStatus="j">
                        <tr>
	                       ...
	                       <td>${s.complaidescription}</td>
	                       <td>${s.complainDate}</td>
							<td>${s.complainTime}</td>
							<td>${s.fromId.username}</td>
                           
                            <td>
                             
                               <button class="btn btn-outline-primary"><a href="viewcomplainrecordpage?complainid=${s.complainid}"">Reply</a></button>
                            </td>
                        </tr>
