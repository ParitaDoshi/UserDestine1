          ...
          <div class="row">
            <div class="col-lg-12">
              ...
              <%@taglib prefix="f" uri="http://www.springframework.org/tags/form"%>
                  <f:form class="cmxform" id="signupForm" method="get" action="addarea" modelAttribute="x">
                    <fieldset>
                    
                   <div class="form-group">
                        <label for="City Name">City Name</label><br/>
                        <f:select path="cityforeignkeyvo.cityid" class="form-control" required="required">
                       ...
                       <div class="form-group">
                        ...
                        <f:input path="areaname" class="form-control" required="required"></f:input>
                      </div>
                      
                      <div class="form-group">
                        <label for="Area Description">Area Description</label><br/>
                        <f:textarea path="areadescription" rows="5" cols="30" class="form-control" required="required"></f:textarea>
                      </div>
                      <f:hidden path="areaid"></f:hidden>
