...
<jsp:include page="header.jsp"></jsp:include>
 ...
 <jsp:include page="menu.jsp"></jsp:include>
                 ...
                 <div class="card-body">
                  <div class="d-flex flex-column flex-md-row align-items-center justify-content-between">
                      ...
                      <div class="statistics-item">
                        ...
                        <h2>${sessionScope.restaurantList}</h2>
                      ...
                      <div class="statistics-item">
                        ...
                        <h2>${sessionScope.complainList}</h2>
                      ...
                      <div class="statistics-item">
                        ...
                        <h2>${sessionScope.feedbackList}</h2>
                  ...
                  <ul class="solid-bullet-list">
                    <li>
                      ...
                      <div class="image-layers">
                        ...
                        <img class="img-sm rounded-circle image-layer-item" src="${pageContext.request.contextPath}/adminResources/images/faces/face3.jpg" alt="profile"/>
                        <img class="img-sm rounded-circle image-layer-item" src="${pageContext.request.contextPath}/adminResources/images/faces/face5.jpg" alt="profile"/>
                        <img class="img-sm rounded-circle image-layer-item" src="${pageContext.request.contextPath}/adminResources/images/faces/face8.jpg" alt="profile"/>
                      </div>
                    </li>
                    <li>
                    ...
                    <table class="table">
                      <tbody>
                        <tr>
                          ...
                          <td class="py-1">
                            <img src="${pageContext.request.contextPath}/adminResources/images/faces/face13.jpg" alt="profile" class="img-sm rounded-circle"/>
                          </td>
                        ...
                        <tr>
                          ...
                          <td class="py-1">
                            <img src="${pageContext.request.contextPath}/adminResources/images/faces/face2.jpg" alt="profile" class="img-sm rounded-circle"/>
                          </td>
                          <td class="font-weight-bold">
                            Mae Saunders
                          </td>
                        ...
                        <tr>
                          ...
                          <td class="py-1">
                            <img src="${pageContext.request.contextPath}/adminResources/images/faces/face11.jpg" alt="profile" class="img-sm rounded-circle"/>
                          </td>
                          <td class="font-weight-bold">
                            Marguerite Phillips
                          </td>
                  ...
                  <div class="table-responsive">
                    <table class="table">
                      ...
                      <tbody>
                        <tr>
                          <td class="py-1">
                            <img src="${pageContext.request.contextPath}/adminResources/images/faces/face1.jpg" alt="profile" class="img-sm rounded-circle"/>
                          </td>
                          <td>
                            South Shyanne
                          </td>
                        ...
                        <tr>
                          <td class="py-1">
                            <img src="${pageContext.request.contextPath}/adminResources/images/faces/face3.jpg" alt="profile" class="img-sm rounded-circle"/>
                          </td>
                          <td>
                            East Helga
                          </td>
                        ...
                        <tr>
                          <td class="py-1">
                            <img src="${pageContext.request.contextPath}/adminResources/images/faces/face4.jpg" alt="profile" class="img-sm rounded-circle"/>
                          </td>
                          <td>
                            Omerbury
                          </td>
  ...
  <script src="${pageContext.request.contextPath}/adminResources/js/dashboard.js"></script>
