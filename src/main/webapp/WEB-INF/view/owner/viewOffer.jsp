                  ...
                  <div class="table-responsive">
                    <table id="order-listing" class="table">
                      <thead>
                        <tr>
                            ...
                            <th>Offer Time To</th>
                            <th>Offer Time From</th>
                            <th>Offer Discount Price</th>
                            <th>Offer Final Price</th>
                   ...
                   <c:forEach items="${viewdata}" var="s">
                        <tr>
                        	...
                        	<td>${s.itemfvo.itemname}</td>
                        	<td>${s.itemfvo.itemprice}</td>
	                        <td>${s.offername}</td>
	                        <td>${s.offerdateto}</td>
	                        <td>${s.offerdatefrom}</td>
	                        <td>${s.offertimeto}</td>
	                        <td>${s.offertimefrom}</td>
	                        <td>${s.offerDiscountPrice}</td>
	                        <td>${s.offerFinalPrice}</td>
                            <td>${s.offerdescription}</td>
                           
                            <td>
                              <button class="btn btn-outline-primary" ><a href="editofferpage?offerid=${s.offerid}"">Edit</a></button>
                               <button class="btn btn-outline-primary"><a href="deleteofferdata?offerid=${s.offerid}"">Delete</a></button>
                            </td>
                        </tr>
