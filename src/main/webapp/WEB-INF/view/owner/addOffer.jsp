            ...
            <div class="col-lg-12">
              ...
              <f:select path="categoryforeignkeyvo.category_id" class="form-control" id="category_id"  onchange="fn()" required="required">
                     ...
                     <div class="form-group">
                        ...
                        <f:select path="subcategoryfVO.subcategoryid" class="form-control" id="subcategoryname"  onchange="fn1()" required="required">
                       ...
                       <div class="form-group">
                        ...
                        <f:select path="itemfvo.itemid" class="form-control"  id="itemid" onchange="fn2()" required="required">
							<option>---select---</option>
                        </f:select>
                      </div> 
	                   	...
	                   	<div class="form-group">
	  							...
	  							<f:input path="itemfvo.itemprice" class="form-control" id="itemprice" readonly="true" required="required"></f:input>
												</div>
                    			  ...
                    			  <div class="form-group">
											...
											<div class="form-group">
												<label for="Offer Name"><b>Offer Final Price</b></label> <f:input
													path="offerFinalPrice" class="form-control"required="required"
													 id="itemFinalPrice" readonly="true"></f:input>
											</div>
