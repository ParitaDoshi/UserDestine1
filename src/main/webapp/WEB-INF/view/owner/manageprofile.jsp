              ...
              <div class="card">
                <div class="card-body">
                 ...
                 <%@taglib prefix="f" uri="http://www.springframework.org/tags/form"%>
                  <f:form class="cmxform" id="commentForm" method="post" action="addregisterdataowner" modelAttribute="x" enctype="multipart/form-data" >
                    ...
                    <div class="form-group">
                      ...
                      <f:input path="firstname" class="form-control"  minlength="2" type="text" required="required" />
                      </div>
                   
                   
                       <div class="form-group">
                       <label for="cname"> Last Name (required, at least 2 characters)</label>
                      <f:input path="lastname" class="form-control"  minlength="2" type="text" required="required"/>
                      </div>
                      
                      
                      
                       <div class="form-group">
                       <label for="cname"> User Name (required, at least 2 characters)</label>
                     <f:input path="loginfvo.username" class="form-control" minlength="2" type="text" required="required"/>
                      </div>
                     ...
                     <f:input path="mobileno" class="form-control" minlength="2" type="text" required="required"/>
                      </div>
                      
                      
                        <div class="form-group">
                        <label for="cemail">E-Mail (required)</label>
                       <f:input path="emailid" class="form-control" type="email"  required="required"  />
                      </div>
                      
                      
                       <div class="form-group">
                       <label for="cname"> Owner Shop Name(required, at least 2 characters)</label>
                      <f:input path="ownershopname" class="form-control"  minlength="2" type="text" required="required"/>
                      </div>
                      
                      
                       <div class="form-group">
                       <label for="cname"> Owner Shop Description(required, at least 2 characters)</label>
                      <f:input path="shopdescription" class="form-control"  minlength="2" type="text" required="required" />
                      </div>
                     ...
                     <div class="form-group">
                       ...
                       <div class="form-group">
                       <label for="cname"> Password (required, at least 2 characters)</label>
                      <f:input path="loginfvo.password" class="form-control" minlength="2" type="text" required="required" />
                      </div>
                       ...
                       <div class="form-group">
                       <label for="cname">Address (required, at least 2 characters)</label>
                       <f:textarea path="address" rows="5" cols="30" class="form-control"  minlength="2" type="text" required="required" />
                      </div>
                      
                      
                      
                       <div class="form-group">
                        <label for="cemail">Gender(required)</label>
                        <f:radiobutton path="gender" class="form-control" value="Male" required="required"/>Male
                 		 <f:radiobutton path="gender" class="form-control" value="Female" required="required"/>Female
                      </div>
                     ...
                     <f:hidden path="ownerregistrationid"/>
                       <f:hidden path="loginfvo.loginid"/>
