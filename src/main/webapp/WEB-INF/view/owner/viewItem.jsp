                  ...
                  <div class="table-responsive">
                   ...
                   <c:forEach items="${viewdata}" var="s">
                        <tr>
	                        ...
	                        <td>${s.itemname}</td>
	                        <td>${s.itemtype}</td>
	                        <td> <img src="${pageContext.request.contextPath}/item/${s.itemProfilePhotoName}" alt=""></td>
	                        <td>${s.itemprice}</td>
	                         <td>${s.itemsize}</td>
                            <td>${s.itemdescription}</td>
                           
                            <td>
                              <button class="btn btn-outline-primary" ><a href="edititempage?itemid=${s.itemid}"">Edit</a></button>
                               <button class="btn btn-outline-primary"><a href="deleteitemdata?itemid=${s.itemid}"">Delete</a></button>
                            </td>
                        </tr>
