		  ...
		  <%@taglib prefix="f" uri="http://www.springframework.org/tags/form"%>  
                 ...
                 <div class="col-xl-7 col-lg-6">
                        <div class="contact-form-wrapper">
                         ...
                         <f:form id="signupForm" method="get" action="addfeedback" modelAttribute="x">
                                <div class="form-box required">
                                    <f:input path="feedback" placeholder="Feedback" required="required"></f:input>
                                </div>
                                
                                <div class="form-box required textarea">
                                    <f:textarea path="feedbackmessage" cols="30" rows="10" placeholder="Feedback_Message" required="required"></f:textarea>
                                </div>
