...
<!-- 											<div class="col-lg-6 grid-item breakfast dinner party"> -->
											<div class="col-lg-6 grid-item ${j.itemtype}">
												<div class="menu-item">
													<div class="menu-image">
														<a href="menu.html"><img
															src="${pageContext.request.contextPath}/item/${j.itemProfilePhotoName}"
															alt=""></a>
													</div>
													<div class="menu-text">
														<h4>
															<a href="menu.html">${j.itemname}</a><span>${j.itemprice}</span>
														</h4>
														<span>${j.itemdescription}</span>
